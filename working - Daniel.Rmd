...
interaction_model_log_dependent <- lm(log2_avg_sf_home_val ~ log2_pct_sf_home + log2_pct_moved + maj_white + type + log2_pct_sf_home*type, data_log)
...
interaction_model_log_dependent <- lm(log2_avg_sf_home_val ~ log2_pct_sf_home + log2_pct_moved + maj_white + type + log2_pct_moved*maj_white, data_log)
...
interaction_model_log_dependent <- lm(log2_avg_sf_home_val ~ log2_pct_sf_home + log2_pct_moved + maj_white + type + log2_pct_moved*type, data_log)
...
```{r}
effect_plot(model_log_dependent, pred = log2_pct_sf_home, interval = TRUE)

```
*DELETE THIS BEFORE SUBMISSION:*
The interaction plot is describing how the effectiveness *(ability for a variable to predict the average SDDU price)* of "log of people moved" changes when it interacts with the classification type of a census tract.