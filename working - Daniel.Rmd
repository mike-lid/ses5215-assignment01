...
interaction_model_log_dependent <- lm(log2_avg_sf_home_val ~ log2_pct_sf_home + log2_pct_moved + maj_white + type + log2_pct_sf_home*maj_white + log2_pct_sf_home*type + log2_pct_moved*maj_white + log2_pct_sf_home*log2_pct_moved, data_log)
...
```{r}
interact_plot(interaction_model_log_dependent, pred = log2_pct_moved, modx = type,
              interval = TRUE) +
  scale_x_continuous(breaks = breaks <- c(-6, -4, -2, 0, 2),
                     labels = round(breaks + mean(data_log$log2_pct_moved, na.rm = TRUE)),
