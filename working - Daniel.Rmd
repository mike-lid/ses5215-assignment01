...
tidy(moved_model) %>%
  ...
  kable(
    caption = "Coefficient-Level Estimates for a Model Fitted to Estimate Home Values in a Given Massachusetts Census Tract Based on Percentage of Population Moved in Past Year.",
...
tidy(sf_model) %>%
  ...
  kable(
    caption = "Coefficient-Level Estimates for a Model Fitted to Estimate Home Values in a Given Massachusetts Census Tract Based on Percentage of Single Family Homes.",
    col.names = c("Predictor", "B", "SE", "t", "p"),
    digits = c(0, 2, 3, 2, 3))
```
...
tidy(white_model) %>%
  ...
  kable(
    caption = "Coefficient-Level Estimates for a Model Fitted to Estimate Home Values in a Given Massachusetts Census Tract Based on Majority White Population.",
    col.names = c("Predictor", "B", "SE", "t", "p"),
    digits = c(0, 2, 3, 2, 3))
```
...
tidy(type_model) %>%
  ...
  kable(
    caption = "Coefficient-Level Estimates for a Model Fitted to Estimate Home Values in a Given Massachusetts Census Tract Based on Urban-Rural Classification.",
    col.names = c("Predictor", "B", "SE", "t", "p"),
    digits = c(0, 2, 3, 2, 3))
```
...
lm(avg_sf_home_val ~ pct_sf_home + pct_moved + maj_white + type, data) %>%
  ...
  mutate(
    p.value = scales::pvalue(p.value),
    term = c("Intercept", "Percent of Single Family Homes", "Percent Moved (Past Year)", "Majority White", "Large Fringe Metro", "Medium Metro","Micropolitan", "Small Metro")
  ) %>%
  kable(
    caption = "Coefficient-Level Estimates for a Model Fitted to Estimate Home Values in a Given Massachusetts Census Tract",
    col.names = c("Predictor", "B", "SE", "t", "p"),
    digits = c(0, 2, 3, 2, 3))
