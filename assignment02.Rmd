...
```{r geographic mobility, message = FALSE, echo = FALSE, warning = FALSE}
#Quartile
...
```{r percent of single_family homes, message = FALSE, echo = TRUE, warning = FALSE}
#Quartile
...
```{r home values, message = FALSE, echo = TRUE, warning = FALSE}
#Quartile
