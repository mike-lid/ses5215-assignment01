...
This model, with an R2 value of 0.30, shows how the relationship between the log of SDDU home values and the log of percent of SDDUs in a census tract is affected by the log of percentage of people who moved to the census tract that year. In this model, the log of the percentage of SDDUs in a census tract is significant and negative, and the interaction with  the log of percentage of people who moved is also significant and negative. Therefore, the percentage of people who moved has an increasing effect. 
