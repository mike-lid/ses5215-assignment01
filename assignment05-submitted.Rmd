...
initial = lm(avg_sf_home_val ~ pct_sf_home + pct_moved + maj_white + type, data) 
...
table_version_1 = export_summs(full_model, centered_model, 
...
table_version_2 = export_summs(full_model, centered_model, 
             error_format = "(p = {p.value})",
             error_pos = "same",
             model.names = c("Initial", "Centered"),
             coefs = coeff_names)
...
table_version_3 = export_summs(full_model, centered_model, centered_model_scaled,
             error_format = "(p = {p.value})",
             error_pos = "same",
